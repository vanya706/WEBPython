...
from wtforms.validators import DataRequired, Length, Email, InputRequired, EqualTo, Regexp, ValidationError
...
class DataForm(FlaskForm):
    ...
    pin = StringField(
        'Pin code*', validators=[InputRequired('Pin code is required'), Regexp('[0-9]{4}',
                                 ...
                                 Length(min=4, max=4)])
    year = SelectField(
        'Year*', choices=[('2021', '2021'), ('2020', '2020'), ('2019', '2019'), ('2018', '2018'), ('2017', '2017'),
